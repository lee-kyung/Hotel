	...
	function check(my)
 	{
 		...
 		{
 			document.getElementById("msg1").innerText="기존 비밀번호를 입력하세요";
 			document.getElementById("msg1").style.color="red";
 			return false;
 		}
 		else if(my.newpwd1.value.trim().length==0)
 		{
 			document.getElementById("msg2").innerText="새로운 비밀번호를 입력하세요";
 			document.getElementById("msg2").style.color="red";
 			return false;
 		}
 		else if(my.newpwd2.value.trim().length==0)
 		{
 	 		document.getElementById("msg3").innerText="비밀번호가 일치하지 않습니다.";
 	 		document.getElementById("msg3").style.color="red";
 	 		return false;
 		}
 		else
